	        ...
	        try {
	            ...
	            try {
	                if (Build.CPU_ABI.equalsIgnoreCase("armeabi-v7a")) {
	                    ...
	                    folder = "armeabi";
	                    LogUtil.e("tmessages", "Unsupported arch: " + Build.CPU_ABI);
	                }
	            } catch (Exception e) {
	                LogUtil.e("tmessages", e);
	                folder = "armeabi";
	            ...
	            if (Build.VERSION.SDK_INT == 8) {
	                ...
	                if (destFile.exists()) {
	                    LogUtil.d("tmessages", "Load normal lib");
	                    try {
	            ...
	            if (destLocalFile.exists()) {
	                try {
	                    LogUtil.d("tmessages", "Load local lib");
	                    System.load(destLocalFile.getAbsolutePath());
	                    nativeLoaded = true;
	                    return;
	                } catch (Error e) {
	            ...
	            LogUtil.e("tmessages", "Library not found, arch = " + folder);
