...
import com.photos.utils.LayoutHelper;
import com.photos.widget.BackupImageView;
import com.photos.widget.CheckBox;
...
//	        boolean showing = PhotoViewer.getInstance().isShowingImage(photoEntry.path);
	        ...
	        checkBox.setVisibility(false ? View.INVISIBLE : View.VISIBLE);
	        requestLayout();
	    }
