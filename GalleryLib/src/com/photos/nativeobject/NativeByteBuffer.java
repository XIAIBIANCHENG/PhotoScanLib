...
public class NativeByteBuffer extends AbstractSerializedData{
    ...
    public static NativeByteBuffer wrap(int address) {
        ...
        if (address != 0) {
            ...
            if (position <= result.buffer.limit()) {
                ...
                LogUtil.e("tmessages", "what with position " + position);
            }
    ...
    public void writeInt32(int x) {
        try {
            ...
            LogUtil.e("tmessages", "write int32 error");
        }
    }
    ...
    public void writeInt64(long x) {
        try {
            ...
            LogUtil.e("tmessages", "write int64 error");
        }
    }
    ...
    public void writeBytes(byte[] b) {
        try {
            ...
            LogUtil.e("tmessages", "write raw error");
        }
    }
    ...
    public void writeByte(byte b) {
        try {
            ...
            LogUtil.e("tmessages", "write byte error");
        }
    }
    ...
    public void writeString(String s) {
        try {
            ...
            LogUtil.e("tmessages", "write string error");
        }
    }
    ...
    public void writeByteArray(byte[] b, int offset, int count) {
        try {
            ...
            LogUtil.e("tmessages", "write byte array error");
        }
    }
    ...
    public void writeDouble(double d) {
        try {
            ...
            LogUtil.e("tmessages", "write double error");
        }
    }
    ...
    public int readInt32(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                LogUtil.e("tmessages", "read int32 error");
            }
        }
        return 0;
    }
    ...
    public boolean readBool(boolean exception) {
        ...
        if (exception) {
            ...
            LogUtil.e("tmessages", "Not bool value!");
        }
        return false;
    }
    ...
    public long readInt64(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                LogUtil.e("tmessages", "read int64 error");
            }
        }
        return 0;
    }
    ...
    public void readBytes(byte[] b, boolean exception) {
        try {
            ...
            if (exception) {
                ...
                LogUtil.e("tmessages", "read raw error");
            }
        }
    }
    ...
    public String readString(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                LogUtil.e("tmessages", "read string error");
            }
        }
        return null;
    }
    ...
    public byte[] readByteArray(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                LogUtil.e("tmessages", "read byte array error");
            }
        }
        return null;
    }
    ...
    public double readDouble(boolean exception) {
        try {
            ...
            if (exception) {
                ...
                LogUtil.e("tmessages", "read double error");
            }
        }
        return 0;
    }
